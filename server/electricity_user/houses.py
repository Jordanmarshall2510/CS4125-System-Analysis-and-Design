...
class House(ElectricityUser):
    ...
    def __init__(self):
        ...
        self.total_electricity_usage = self.get_random_electricity_usage(
            self.number_of_occupants, self.age_of_house)
    ...
    def get_random_house_value(self, age_of_house):
        ...
        value = random.randint(self.average_house_value - house_value_tolerance,
                               self.average_house_value + house_value_tolerance)
        if age_of_house < 20:
            return value
        else:
    ...
    def get_random_electricity_usage(self, number_of_occupants, age_of_house):
        ...
        daily_average_usage = random.randint(
            self.average_electricity_usage - electricity_usage_tolerance, self.average_electricity_usage + electricity_usage_tolerance)/4
