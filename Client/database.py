...
class Database:
    ...
    def select_used_power_history(self, type: str):
        ...
        """
        self.cur.execute(
            "SELECT power_used FROM users WHERE type = ? ORDER BY time", [type])
    ...
    def select_generated_power_history(self, type: str):
        ...
        """
        self.cur.execute(
            "SELECT power_generated FROM generators WHERE type = ? ORDER BY time", [type])
        return self.cur.fetchall()
    ...
    def select_total_used_power_history(self):
        ...
        """
        self.cur.execute(
            "SELECT SUM(power_used) AS total FROM users GROUP BY time")
        return self.cur.fetchall()
    ...
    def select_total_generated_power_history(self):
        ...
        """
        self.cur.execute(
            "SELECT SUM(power_generated) AS total FROM generators GROUP BY time")
        return self.cur.fetchall()
